<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logginn.aspx.cs" Inherits="Elisabeth_I_stem.logginn" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Identifikasjon</title>
...
<body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" aria-current="page" href="logginn.aspx">Stem her</a>
    ...
    <div class="row justify-content-center align-items-center";>
        ...
        <div>
            ...
            <br />
            <br />
           <h4 style="color: white;"> Skriv inn engangskoden din:</h4></div>
            <br />
